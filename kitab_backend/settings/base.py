"""
Base Django Settings for Kitab Backend
Bu faylı development və production settings faylları import edir
"""
...
environ.Env.read_env('.env.local')  # local .env.local üçün

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent.parent

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-default-secret-key-change-in-production')
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Heroku üçün static files
